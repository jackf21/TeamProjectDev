...
<head>
    ...
    <title>MyStudy - Study Advice</title>
    <link rel="stylesheet" href="./css//StudyAdviceStyle.css">
</head>
<body>
    <header id="banner">
    ...
    <h1 id="mainTitle" class="center"><b>"STUDY ADVICE"</b></h1>
    ...
    <section id="faqSection">
        ...
        <div class="faqItem">
            <h3>Q1: How can I improve my study habits?</h3>
            <p id="ans2">A1: You can improve your study habits by creating a study schedule, staying organized, taking breaks, and seeking help when needed.</p>
        </div>
        <div class="faqItem">
            <h3>Q2: How can I create an effective study schedule?</h3>
            <p id="ans2">A2: To create an effective study schedule, prioritize your tasks, allocate specific time slots for each subject, and include breaks for optimal productivity.</p>
        </div>
        
        <div class="faqItem">
            <h3>Q3: What are some effective study techniques?</h3>
            <p id="ans2">A3: Effective study techniques include active learning, spaced repetition, summarizing information, and teaching others.</p>
        </div>

        <div class="faqItem">
            <h3>Q4: How do I stay motivated while studying?</h3>
            <p id="ans2">A4: To stay motivated while studying, set specific goals, reward yourself for progress, find a study buddy, and remind yourself of the benefits of your studies.</p>
        </div>


        <div class="faqItem">
            <h3>Q5: How can I manage my time effectively for studying?</h3>
            <p id="ans2">A5: You can manage your time effectively for studying by prioritizing tasks, using time management tools, avoiding multitasking, and setting realistic deadlines.</p>
        </div>

        <div class="faqItem">
            <h3>Q6: What is the best study environment?</h3>
            <p id="ans2">A6: The best study environment is quiet, well-lit, and free from distractions. Find a comfortable space where you can focus on your studies.</p>
        </div>

        <div class="faqItem">
            <h3>Q7: What should I do if I feel overwhelmed with my studies?</h3>
            <p id="ans2">A7:If you feel overwhelmed with your studies, take a break to recharge, break down tasks into smaller steps, seek support from peers or mentors, and practice self-care.</p>
        </div>
